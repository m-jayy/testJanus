...
public class WebSocketChannel {
        ...
        try {
            ...
            if (janus.equals("success")) {
                ...
                if (handle == null) {
                    ...
                    else if(plugin.optString("videoroom").equals("attached")) {
                        BigInteger UserID = new BigInteger(plugin.optString("id"));
                        Log.e("abc", "aya: "+UserID);
                    }
    ...
    private void publisherJoinRoom(JanusHandle handle) {
        ...
        try {
            ...
            body.putOpt("display", "Mohsin Android");
